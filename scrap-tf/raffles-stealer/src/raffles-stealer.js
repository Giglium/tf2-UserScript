...
function getNewRaffles() {
    ...
    if (panels.length > 1) {
        rafflePanel = panels[1];
    }// panels[0] == won raffles panel
    else {
        rafflePanel = panels[0];
    }
...
(function () {
    ...
    div.textContent = "Checking for new Raffles";
    ...
    if (raffles.length === 0) {
        ...
        if (enterRaffleButton != null) {
            ...
            let countdown = setInterval(() => {
                ...
                div.textContent = "I\"ll enter in the raffle in: " + seconds + "s ";

                if (distance < 0) {
                    clearInterval(countdown);
                    div.textContent = "I am entering in the Raffle";
                    enterRaffleButton.click();
                    seconds = Math.floor((getRandomTime() % (1000 * 60)) / 1000);
                    div.textContent = "Wait " + seconds + " seconds before continue...";
            ...
            div.textContent = "Checking for new raffles, please wait...";
